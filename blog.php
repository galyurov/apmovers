...
<head>
	...
	<link type="text/css" rel="stylesheet" href="<?php echo get_template_directory_uri (); ?>/css/input.css">
	<link type="text/css" rel="stylesheet" href="<?php echo get_template_directory_uri (); ?>/css/calendar.css">
...
L1.024,404.992C3.488,420.192,16.096,432,32,432h448c15.904,0,28.512-11.808,30.976-27.008L310.08,277.952z" />
				...
				<a href="mailto:info@alwayspromove.com" class="footer-item-text phone">info@alwayspromove.com</a>
			</div>
...
c5.297,1.75,10.582,3.527,15.871,5.297c1.207,0.402,1.896,1.193,1.971,2.558C74.786,66.688,74.618,67.445,74.279,68.119z" />
		...
		<div class="footer-col footer-contact">
			...
			<form action="">
                            <div class="footer-item">
                                <input type="text" id="footerInputName" required placeholder="Name"  class="footer-input">
                            </div>
                            <div class="footer-item">
                                <input type="text" id="footerInputEmail" required placeholder="Email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$"  class="footer-input">
                            </div>
                            <div class="footer-item">
                                <input type="text" id="footerInputPhone" required placeholder="Phone"   class="footer-input">
                            </div>
                            <div class="footer-item">
								<textarea id="footerInputText" required placeholder="Message" maxlength="500"   class="footer-input input-message"></textarea>
                            </div>
                            <div class="submit-button">
                                <button id="footerButton"  type="submit">Send Message</button>
                            </div>
                        </form>
		</div>
	</div>
...
<script src="<?php echo get_template_directory_uri (); ?>/js/script.js"></script>
			 <script src="<?php echo get_template_directory_uri (); ?>/js/calendar-small.js"></script>
<script src="<?php echo get_template_directory_uri (); ?>/js/geolocate.js"></script>
<script
